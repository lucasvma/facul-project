...
function _email() {
  _email = _asyncToGenerator(function* (email, provider, options) {
    try {
      var _provider$generateVer, _provider$generateVer2;
      ...
      var token = (_provider$generateVer = (_provider$generateVer2 = provider.generateVerificationToken) === null || _provider$generateVer2 === void 0 ? void 0 : _provider$generateVer2.call(provider)) !== null && _provider$generateVer !== void 0 ? _provider$generateVer : (0, _crypto.randomBytes)(32).toString('hex');
